...
public class ControladorProductos implements ActionListener {
    ...
    private void cargarProductos() {
        try {
            ...
            ArrayList<String[]> datos = bd.consultar("Productos", null, "activo = 1");
            bd.cerrarConexion();
            ...
            if (datos != null) {
                ...
                String[] columnas = {"ID", "SKU", "Producto", "Categoría", "Precio", "Marca", "Stock", "Descripción","Proveedores"};
    ...
    private void buscarPorNombre() {
        ...
        try {
            BaseDatos bd = new BaseDatos();
            ArrayList<String[]> resultado = bd.consultar("Productos", "idProducto, sku, producto, descripcion, precio_venta, stock, idcategoria, marca,activo=1", "producto LIKE '%" + nombre + "%' AND activo=1");
            bd.cerrarConexion();
